describe("parse", function()
  ...
  it("parses iso8601 date and time when year and week year differ", function()
    local format = icu_date.formats.iso8601()
    date:parse(format, "2014-12-31T00:00:00.000Z")
    assert.equal("2014", date:format(icu_date.formats.pattern("yyyy")))
    assert.equal("2015", date:format(icu_date.formats.pattern("YYYY")))
    assert.equal("2014-12-31T00:00:00.000Z", date:format(format))
    assert.equal(1419984000000, date:get_millis())
  end)
